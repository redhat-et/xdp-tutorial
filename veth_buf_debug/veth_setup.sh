...
# docker exec cndp-frr2 ethtool -K veth8 gro on
# docker exec cndp-frr2 ethtool -K veth6 gro on
# docker exec cndp-frr1 ethtool -K veth2 gro on
# docker exec cndp-frr1 ethtool -K veth4 gro on
# ethtool -K veth7 gro on
# ethtool -K veth5 gro on
